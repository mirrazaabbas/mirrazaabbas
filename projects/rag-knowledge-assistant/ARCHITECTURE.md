...
Retrieved documents are data, not trusted instructions. A production version should isolate system instructions from retrieved content, validate uploads, restrict file types/sizes, avoid logging sensitive text, and evaluate prompt-injection cases.
